...
def getData(movies, C3D_path):
    ...
    hdf = h5py.File(
        '/home/uribernal/Desktop/MediaEval2016/devset/continuous-movies/DB/final/temporal_localitzation_output_myData_resized.h5', 'w')
    # Create the structure of the DB
    hdf.close()
    with h5py.File(
            '/home/uribernal/Desktop/MediaEval2016/devset/continuous-movies/DB/final/temporal_localitzation_output_myData_resized.h5',
            'r+') as hdf:
        # Store data
...
def lstm_emotion(batch_size, dropout_probability, summary=False):
    #model = Sequential()
    ...
    lstm = LSTM(1024, return_sequences=True, stateful=True, name='lsmt')(input_dropout)
    output_dropout = Dropout(p=dropout_probability)(lstm)
    lstm2 = LSTM(512, return_sequences=True, stateful=True, name='lsmt2')(output_dropout)
    output_dropout2 = Dropout(p=dropout_probability)(lstm2)
    output = TimeDistributed(Dense(1, activation='tanh'), name='fc')(output_dropout2)
...
def train_model(experiment_id, epochs, dropout_probability, batch_size, lr):
    ...
    C3D_path = '/home/uribernal/Desktop/MediaEval2016/devset/continuous-movies/DB/final/temporal_localitzation_output_myData_resized.h5'
    ...
    # Get the LSTM model
    model = lstm_emotion(batch_size, dropout_probability, True)
