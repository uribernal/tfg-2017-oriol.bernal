...
experiment_id = 1
input_dataset1 = '/home/uribernal/Desktop/MediaEval2016/devset/continuous-movies/DB/dataset.h5'
input_dataset2 = '/home/uribernal/Desktop/MediaEval2016/devset/continuous-movies/DB/lab.h5'
num_cells = 512
num_layers = 1
...
f_dataset1 = h5py.File(input_dataset1, 'r')
f_dataset2 = h5py.File(input_dataset2, 'r')

X = f_dataset1['MOVIES']
Y = f_dataset2['LABELS/AROUSAL']
print(X)
print(Y)
...
#sample_weight = f_dataset1['training']['sample_weight'][...]
