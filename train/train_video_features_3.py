...
if __name__ == '__main__':
    ...
    train(60, 512, 'Adam', 1, 1, 0.5, split=0)
    train(60, 1024, 'Adam', 1, 1, 0.5, split=0)
    train(60, 2048, 'Adam', 1, 1, 0.5, split=0)
    train(60, 256, 'Adam', 1, 1, 0.5, split=0)
