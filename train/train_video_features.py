...
def train_and_evaluate_model(experiment_id, optimizer, batch_size, timesteps, dropout, data_split):
    ...
    validation_loss_epoch = np.array([])
    train_loss = []
    validation_loss = []
    for i in range(30):
        # shuffle movies
...
if __name__ == '__main__':
    ...
    train('Adam', 1, 1, 0.5, starting_lr=1e-2, lr_patience=0, stop_patience=0, data_split=1)
    train('Adam', 1, 1, 0.5, starting_lr=1e-4, lr_patience=0, stop_patience=0, data_split=2)
    train('Adam', 1, 1, 0.5, starting_lr=1e-4, lr_patience=0, stop_patience=0, data_split=3)
    train('Adam', 1, 1, 0.5, starting_lr=1e-4, lr_patience=0, stop_patience=0, data_split=4)
    train('Adam', 1, 1, 0.5, starting_lr=1e-4, lr_patience=0, stop_patience=0, data_split=5)
    train('Adam', 1, 1, 0.5, starting_lr=1e-4, lr_patience=0, stop_patience=0, data_split=6)
    train('Adam', 1, 1, 0.5, starting_lr=1e-4, lr_patience=0, stop_patience=0, data_split=7)
    train('Adam', 1, 1, 0.5, starting_lr=1e-4, lr_patience=0, stop_patience=0, data_split=8)
    train('Adam', 1, 1, 0.5, starting_lr=1e-4, lr_patience=0, stop_patience=0, data_split=9)
